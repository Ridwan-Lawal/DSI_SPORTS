...
export default async function PremierLeagueNewsCard({
  article,
}: OtherArticleProp) {
  ...
  return (
    <Link
      href={`/news/${slug}`}
      className="w-[300px] shrink-0 space-y-4 self-stretch overflow-hidden border-b border-neutral-200 pb-5 md:space-y-8 md:rounded-sm md:border md:border-neutral-100 md:shadow-sm md:shadow-neutral-100"
    >
